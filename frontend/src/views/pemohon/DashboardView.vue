  ...
  <MainLayout>
    ...
    <div class="mb-6 animate-fade-in">
      <div class="flex items-center justify-between">
        ...
        <router-link v-if="authStore.isPemohon" to="/pengajuan/baru" class="btn btn-primary gap-2">
          ...
          <table class="data-table">
            ...
            <tbody>
              <tr v-for="item in recentPengajuan" :key="item.id">
                ...
                <td>
                  <router-link :to="`/pengajuan/${item.id}`" class="btn btn-ghost btn-sm text-primary-600 hover:text-primary-700 hover:bg-primary-50">
